...
- 🌱 I’m writing an Android game to learn about WebSockets and real-time UI
...
- [VideoConferencing](https://github.com/realityexpander/AgoraUIKit) - Video Conferencing app using Compose and Agora video conferencing library (requires key generation for 24 hour access)
...
- [Tesla App](https://github.com/realityexpander/TeslaRoadster) - Clone of the Tesla Roadset site as an Android App with HTML5, Bootstrap
