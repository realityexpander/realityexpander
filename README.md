# Chris Athanas
## I'm a Kotlin Multi-Platform (KMP) Developer Specializing in Android, iOS & Web Development

<!--
**realityexpander/realityexpander** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
- 🔭 I’m currently working on KMP (Kotlin Multi-Platform) cross-platform iOS & Android projects & finishing my EE degree at Midlands Tech and University of South Carolina
...
- My Famous Free Programming Course: How to Program From the Ground Up YouTube Series - [Click here for the follow-along live-code document](https://github.com/realityexpander/How_to_program_from_ground_up)
...
- [Calorie Track](https://github.com/realityexpander/CalorieTrack) - Multi-module CLEAN architecture app to track calories using [`Open Food Api`](https://world.openfoodfacts.org/)
  ...
  - Calculus I Bounce Simulation explorer for Derivative graphs of position, velocity & acceleration
    - [<img width="325" alt="image" src="https://github.com/user-attachments/assets/99a716b1-b080-4f31-b48b-775336fe46d5" />](https://realityexpander.github.io/Calculus-I-Bounce-Simulation/)
...
- [Charlly Finely Life Coach](https://github.com/realityexpander/CharllyLifeCoach) - Charlly Finely - AI Motivational Life Coach will quickly solve all your problems!
